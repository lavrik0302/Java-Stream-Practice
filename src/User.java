...
public class User {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Сумма всех возрастов сотрудников = " + ageSum(list));
        System.out.println();
        System.out.printf("Средний возраст сотрудников = %.2f\n", avgAge(list));
        System.out.println();
        System.out.println("Список сотрудников которым > 30:");
        System.out.println();
        ...
        System.out.println();
        System.out.println("Список сотрудников отсортированный по дате приема на работу: ");
        System.out.println();
